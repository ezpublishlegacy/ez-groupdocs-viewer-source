...
<div style="padding:10px;border:3px double gray;width:675px;">
	<form method="post" action={'groupdocsviewer/config'|ezurl}>
	<table><tr>
...
{*List: {fetch( 'groupdocsviewer', 'list', hash( 'as_object', true() ) )|attribute( 'show' )} - to use this just need to add functions in config.php*}
